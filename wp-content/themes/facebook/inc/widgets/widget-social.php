 ...
 * @since      1.0.0
 */
class myshare_pro_Social_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-myshare_pro-social widget_social_icons',
			'description' => __( 'Display your social media icons.', 'myshare-pro' )
		);

		// Create the widget.
		parent::__construct(
			'myshare_pro-social',                        // $this->id_base
			__( '&raquo; Social Icons', 'myshare-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Follow Us', 'myshare-pro' ),
			'desc'       => esc_html__( 'Stay updated via social channels', 'myshare-pro' ),		
			'facebook'   => '',
			'twitter'    => '',
			'gplus'      => '',
			'pinterest'  => '',
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'desc' ); ?>">
				<?php _e( 'Description', 'myshare-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'gplus' ); ?>">
				<?php _e( 'Google Plus', 'myshare-pro' ); ?>
			</label>
