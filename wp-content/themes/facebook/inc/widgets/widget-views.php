 ...
 * @since      1.0.0
 */
class myshare_pro_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-myshare_pro-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'myshare-pro' )
		);

		// Create the widget.
		parent::__construct(
			'myshare_pro-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'myshare-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'myshare-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
