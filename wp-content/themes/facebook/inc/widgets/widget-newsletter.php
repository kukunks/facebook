 ...
 * @since      1.0.0
 */
class myshare_pro_Newsletter_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( 'Display newsletter subscribe form.', 'myshare-pro' ),
			'customize_selective_refresh' => true
		);

		// Create the widget.
		parent::__construct(
			'myshare_pro-newsletter',                                    // $this->id_base
			esc_html__( '&raquo; Newsletter', 'myshare-pro' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>">
				<?php esc_html_e( 'Title', 'myshare-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'form_code' ); ?>">
				<?php esc_html_e( 'Subscribe Form Code', 'myshare-pro' ); ?> <span style="display: block;color: #90949c;">See <a href="https://www.happythemes.com/demo/myshare-pro/wp-content/themes/myshare-pro/form-example.txt" target="_blank">example code</a>.</span>
			</label>
