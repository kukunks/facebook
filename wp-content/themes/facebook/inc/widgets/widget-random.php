 ...
 * @since      1.0.0
 */
class myshare_pro_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-myshare_pro-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'myshare-pro' )
		);

		// Create the widget.
		parent::__construct(
			'myshare_pro-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'myshare-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'myshare-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
