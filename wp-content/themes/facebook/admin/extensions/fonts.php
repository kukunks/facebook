...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'myshare-pro' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'myshare-pro' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'myshare-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'myshare-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'myshare-pro' ),
		'devanagari'   => __( 'Devanagari', 'myshare-pro' ),
		'greek'        => __( 'Greek', 'myshare-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'myshare-pro' ),
		'khmer'        => __( 'Khmer', 'myshare-pro' ),
		'latin'        => __( 'Latin', 'myshare-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'myshare-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'myshare-pro' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'myshare-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'myshare-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'myshare-pro' ),
