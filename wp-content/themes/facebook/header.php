...
<?php
	...
	// Theme Color
	$primary_color = get_theme_mod('primary-color', '#4267b2');
	$secondary_color = get_theme_mod('secondary-color', '#4267b2');	
	...
	<header id="masthead" class="site-header">
		...
		<div id="primary-bar">
			...
			<?php if ( get_theme_mod('header-search-on', true) ) : ?>
				...
				<div class="header-search">
					<form id="searchform" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						<input type="search" name="s" class="search-input" placeholder="<?php esc_html_e('Search...', 'myshare-pro'); ?>" autocomplete="off">
			...
			<nav id="primary-nav" class="main-navigation">
				...
				?>
					...
					<ul id="primary-menu" class="sf-menu">
						<li><a href="<?php echo home_url(); ?>/wp-admin/nav-menus.php"><?php echo __('Add menu for: Primary Menu', 'myshare-pro'); ?></a></li>
					</ul><!-- .sf-menu -->
			...
			<span class="mobile-menu-icon">
				<span class="menu-icon-open"><?php echo __('Menu', 'myshare-pro'); ?></span>
			...
			<nav id="secondary-nav" class="secondary-navigation">
				...
				?>
					...
					<ul id="secondary-menu" class="sf-menu">
						<li><a href="<?php echo home_url(); ?>/wp-admin/nav-menus.php"><?php echo __('Add menu for: Secondary Menu', 'myshare-pro'); ?></a></li>
					</ul><!-- .sf-menu -->
		...
		<div class="mobile-menu clear">
			...
			<?php 
				...
				if ( has_nav_menu( 'primary' ) ) {
					...
					echo '<h3>' . get_theme_mod('primary-nav-heading', __('Pages', 'myshare-pro')) . '</h3>';
				...
				if ( has_nav_menu( 'secondary' ) ) {
					...
					echo '<h3>' . get_theme_mod('secondary-nav-heading', __('Categories', 'myshare-pro')) . '</h3>';
